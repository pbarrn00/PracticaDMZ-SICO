...
iptables -A FORWARD -p tcp -i eth2 -o eth0 -s 10.5.2.0/24 -d 10.5.1.0/24 -m state --state NEW -j ACCEPT
iptables -A FORWARD -p udp -i eth2 -o eth0 -s 10.5.2.0/24 -d 10.5.1.0/24 -m state --state NEW -j ACCEPT
